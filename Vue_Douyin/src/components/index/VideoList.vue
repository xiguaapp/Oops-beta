    ...
    <div class="comment-warp" v-if="present">
      <div class="comment-list">
        ...
        <div>
          ...
          <el-tab-pane label="礼物" name="first">
                  <div class="zwe"> 
                    <div></div>
                  <p class="pitch" :class="{active2:currentIndex === index}" @click="liClick(index,item.gifprice,item.gifimageurl)" v-for="(item,index)  in list">
                  <span></span></br>
          ...
          <el-tab-pane label="背包" name="second">背包</el-tab-pane>
...
//引入api
import { recommend,giflist } from '@/api/video.js';
//引入api
import { personage,addcomment,give,callgive} from '@/api/video';
...
liClick(index,r,url){
    ...
    close(){
      ...
      //   id: 7,
      //   //用户头像
      //   avatar: 'https://guil-file-200211.oss-cn-beijing.aliyuncs.com/Oops/logo.jpg',
      //   //弹幕的内容
      //   msg: this.input,
      //   time: 7,
      //   barrageStyle: 'red'
        ...
        list:[
              {
                ...
                gifname:'烟花',
                gifprice:98,
                gifimageurl:'https://wimg.588ku.com/gif620/20/12/06/350cc05ccdbdfb5b195f7d045f6da356.gif',
              },
              {
                id:1,
                name:'牛年大吉',
                currency:108,
                scrimg:'https://wimg.588ku.com/gif620/20/11/12/100410d50538e639a731c33107837d7a.gif',
              },
              {
                id:1,
                name:'招财进宝',
                currency:168,
                scrimg:'https://wimg.588ku.com/gif620/20/12/21/251f703322afa52c5f2b2f2b89dbb513.gif',
              },
              {
                 id:1,
                name:'牛气冲天',
                currency:668,
                scrimg:'https://wimg.588ku.com/gif620/20/12/08/c4d38780361d737d193916eee8c6c61b.gif',
              },
              {
                 id:1,
                name:'财神爷',
                currency:1680,
                scrimg:'https://wimg.588ku.com/gif620/20/11/26/ecfef86ba5a3ea1a810311936f9efcae.gif',
              },
              {
                 id:1,
                name:'财源滚滚',
                currency:1260,
                scrimg:'https://wimg.588ku.com/gif620/20/11/26/4d7002eba45c480e7723999d8a61dd9a.gif',
              },
              {
                 id:1,
                name:'棒棒糖',
                currency:10,
                 scrimg:'https://wimg.588ku.com/gif620/20/12/06/350cc05ccdbdfb5b195f7d045f6da356.gif',
              },
              {
                 id:1,
                name:'爱你久久',
